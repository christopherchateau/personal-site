		...
		for (let i = 1; i <= 5; i++)
			colors.push(
				<section
					...
					style={{ background: `${this.state.colors[i - 1]}` }}
					key={i}
				/>
			)
		return colors
